...
CREATE TABLE "links" (
	...
	"created_at" timestamp with time zone DEFAULT now(),
	CONSTRAINT "Links_source_target_unique" UNIQUE("source_url_id","target_url_id")
);
--> statement-breakpoint
...
ALTER TABLE "links" ADD CONSTRAINT "links_target_url_id_urls_id_fkey" FOREIGN KEY ("target_url_id") REFERENCES "urls"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "metadata" ADD CONSTRAINT "metadata_url_id_urls_id_fkey" FOREIGN KEY ("url_id") REFERENCES "urls"("id") ON DELETE CASCADE;